...
# Proposed update is done at line 23
def PROPOSED(population, objective_function, lb, ub, max_iterations):
    ...
    for t in range(max_iterations):
        ...
        for i in range(population_size):
            # Calculate the amount of Botox injection using updated formula
            if t < max_iterations / 2:
                botox_amount = worst_solution - mean_solution - population[i]
            else:
                botox_amount = mean_solution - best_solution - population[i]
